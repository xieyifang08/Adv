...
test_loader_adv = load_data_for_defense(os.path.join(args.data, 'dev.csv'),
                                        "../../data/m_di2_fgsm_input224_resize270299_Ensemble_dsn161_jpeg_rn162_jpeg_l220_step50")['dev_data']
