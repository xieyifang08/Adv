...
# Load the dataset
data_dir = r'D:\12045\adv-SR\imagenet_train_10000\imagenet_train_10000\train'  # Directory where the images are stored
csv_file = r'D:\12045\adv-SR\imagenet_train_10000\imagenet_train_10000\dev.csv'  # Path to the CSV file
...
output_dir = r'D:\adv\PLP\attack_PGD_alexnet_117_torchattack'  # Specify your output directory
# Perform the attack
adv_images = atk(images.to(device), labels.to(device))
