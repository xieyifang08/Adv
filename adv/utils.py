...
def get_imagenet_data():
    ...
    class_idx = json.load(open(r"D:\adv\PLP\data\imagenet_class_index.json"))
    ...
    imagnet_data = image_folder_custom_label(root=r'D:\12045\adv-SR\Diff-PGD-main\Diff-PGD-main\data\imagenet_train_10000\val1',
                                             transform=transform,
                                             idx2label=idx2label)
...
#
#     # 读取 dev.csv 文件
#     dev_csv_path = r"D:\adv\PLP\data\dev.csv"
#     dev_csv = pd.read_csv(dev_csv_path)
#
#     # 创建 idx2label 映射
#     unique_labels = dev_csv['TrueLabel'].unique()
...
#     ])
#
#     imagnet_data = image_folder_custom_label(root=r'D:\adv\PLP\data\test100',
#                                              transform=transform,
#                                              idx2label=idx2label)
#
#     data_loader = torch.utils.data.DataLoader(imagnet_data, batch_size=1, shuffle=False)
